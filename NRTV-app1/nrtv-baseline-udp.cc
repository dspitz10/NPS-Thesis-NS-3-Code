...
std::string simName = "nrtv-baseline-udp";
...
main(int argc, char* argv[])
{
    ...
    LogComponentEnable("nrtv-baseline-udp",LOG_LEVEL_INFO); 
    ...
    nrtvHelper.InstallUsingIpv4(n1n2.Get(0), destNode);

    sourceApps = nrtvHelper.GetServer(); 
    ...
    ApplicationContainer sinkApps = nrtvHelper.GetClients();
    ...
    if (tracing){
        ...
        firstRtt[0] = true;
        string dataFolder = "/home/drew/Thesis/baselinePcapData/ErrRate"+ErrorString+"/NRTV-app1/"+ prefix_file_name +"_Run_"+runNumber;
        if (satSetup == "LEO"){
            dataFolder = "/home/drew/Thesis/baselinePcapData/LEO/ErrRate"+ErrorString+"/NRTV-app1/"+ prefix_file_name +"_Run_"+runNumber;
        }
        AsciiTraceHelper ascii;
    ...
    {
        std::stringstream ThreeNodeUDPnrtv;
        ThreeNodeUDPnrtv << "UDP" <<"-NRTV-" << "ClientRxPlot"<<"TNT-"<<tntEnable <<"RtnDrop-"<<rtnDropEnable;
        plots.push_back(CreateObject<ClientRxTracePlot>(*app, ThreeNodeUDPnrtv.str()));
    }

    NS_LOG_INFO("Starting nrtv-baseline-udp...");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if (Flows) {
        ...
        string outputDir = "/home/drew/Thesis/satStatistics/nrtv-baseline-udp-test";
        string simTag = "nrtv-baseline-udp";//+"-"+errType+"-"+std::to_string(errorRate)+"-"+uploadRate+"-"+delay+".txt";
        ...
        monitor->SerializeToXmlFile(
            "/home/drew/Thesis/satStatistics/nrtv-baseline-udp-test/NRTVflowMonOutput-"+std::to_string(errorRate)+".xml", 
            true, true);
