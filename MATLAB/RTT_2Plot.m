...
titlePrint = 1; % Toggle titles on figures
BL2 = 1; 
...
%%
    ...
    if binLimits 
        ...
        if BL2
            binLims = {[500 700] [450 750]}; 
        end 
        if Leo 
            binLims = {[70 160] [150 350] [200 800] [50 155] [150 750] [150 800]}; 
            if BL2
                binLims = {[60 160] [70 130]}; %30 170
            end    
        end 
        updatedIndices = averages*1000 <= binLims{loopNum}(2);
